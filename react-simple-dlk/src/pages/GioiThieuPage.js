...
import items from "../components/data/nhanvien.json";
const GioiThieuPage = () => {
  return (
    <div className="mb-32">
      <div className="mx-20">
        ...
        <div>
          ...
          <div className="w-2/3 mt-10">
            ...
            <p className="italic mt-12">
              "Đến với Petcare từ những ngày còn là sinh viên, chưa xác định rõ
              con đường sẽ đi. Khi vào thực tập, được các anh chị bác sĩ tận
              tình chỉ dẫn, mình đã quyết định trở thành một bác sĩ thực hành
              thú nhỏ và Petcare chính là môi trường tốt nhất để mình có thể gắn
              bó. Đến hiện tại, mình vẫn nghĩ đó là quyết định đúng đắn và
              Petcare vẫn luôn là nơi gặp gỡ của những tình yêu thương to lớn
